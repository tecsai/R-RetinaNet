...
def convert_hrsc_gt(gt_path, eval_res_dir, level=1, eval_difficult= False):
    ...
    dst_gt = [os.path.join(eval_res_dir, x.replace('.xml','.txt')) for x in gts]
    print('gt generating...')
...
if __name__ == "__main__":
    ...
    eval_res_dir = '/data-tmp/das3/datasets/evaluate/ground-truth'
    eval_difficult = False
    convert_hrsc_gt(gt_path, eval_res_dir, level, eval_difficult)
