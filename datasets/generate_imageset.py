...
def generate_iamgets(dataset=None):
    ...
    if dataset  == 'DOTA':
        # For DOTA
        train_img_path = "/2T/001_AI/1005_RotateRetinaNet/002_Datasets/IRInsu_20230222/train/images" 
        val_img_path = "/2T/001_AI/1005_RotateRetinaNet/002_Datasets/IRInsu_20230222/val/images"
        set_file = '/2T/001_AI/1005_RotateRetinaNet/002_Datasets/IRInsu_20230222/trainval.txt'
