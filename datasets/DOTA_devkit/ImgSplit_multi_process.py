...
import numpy as np
import math
from dota_utils import RecursizeListDir
import cv2
...
class splitbase():
    ...
    def SplitSingle(self, name, rate, extent):
        ...
        width = np.shape(resizeimg)[1]  # 图像宽
        height = np.shape(resizeimg)[0] # 图像高

        left, up = 0, 0
        while (left < width):
            if (left + self.subsize >= width):  # self.subsize = 800
    ...
    def splitdata(self, rate):
        ...
        """
        imagelist = RecursizeListDir(self.imagepath)
...
if __name__ == '__main__':
    ...
    ''' for train '''
    raw_root_dir = '/2T/001_AI/1005_RotateRetinaNet/002_Datasets/DOTA_1.0_1.5_2.0/DOTA_V1.0/train'
    split_root_dir = '/2T/001_AI/1005_RotateRetinaNet/002_Datasets/DOTA_1.0_1.5_2.0/DOTA_V1.0/trainsplit'
    ''' for val '''
    # raw_root_dir = "/2T/001_AI/1005_RotateRetinaNet/002_Datasets/DOTA_1.0_1.5_2.0/DOTA_V1.0/val"
    # split_root_dir = "/2T/001_AI/1005_RotateRetinaNet/002_Datasets/DOTA_1.0_1.5_2.0/DOTA_V1.0/valsplit"
    ''' for test '''
    # raw_root_dir = "/2T/001_AI/1005_RotateRetinaNet/002_Datasets/DOTA_1.0_1.5_2.0/DOTA_V1.0/test"
    # split_root_dir = "/2T/001_AI/1005_RotateRetinaNet/002_Datasets/DOTA_1.0_1.5_2.0/DOTA_V1.0/testsplit"
    ...
    split = splitbase(raw_root_dir,
                      ...
                      subsize=800,
                      num_process=8,
                      is_testset=False  # [SAI-KEY] train和val数据此处为False
                                       # [SAI-KEY] test数据此处为True, 标识无需分割标注文件
                      )
    split.splitdata(1)
