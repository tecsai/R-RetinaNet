...
class CLSHead(nn.Module):
    ...
    def forward(self, x):
        ...
        n, w, h, c = x.shape  # [SAI-KEY] May be "NHWC"
        x = x.reshape(n, w, h, self.num_anchors, self.num_classes)  # N, H, W, NUM_ANCHORS, NUM_CLASSES
        return x.reshape(x.shape[0], -1, self.num_classes) # N, (H*W*NUM_ANCHORS), NUM_CLASSES
